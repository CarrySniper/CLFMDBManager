...
// blcok    数据处理回调 [resultSet stringForColumn:@"xxx"]
typedef void (^CLFMDBBoolBlock)(FMDatabase *db, BOOL successful);
typedef void (^CLFMDBResultBlock)(NSArray<NSDictionary *> *resultSets);
